...
The input files required should be in ABH format, which can be obtained from VCF files using TASSEL 5 (also demonstrated in the YouTube video. Check it out!).
